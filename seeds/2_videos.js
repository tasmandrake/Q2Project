  ...
  return knex('videos').del()
    .then(() => {
      return knex('videos').insert([
        {
          id: 1,
          video_url: 'Tllw4EPhLiQ&t=5s',
          img: 'https://cdn-images-1.medium.com/max/800/1*jAG7WcT_5ORS6BmpI1LJGg.jpeg',
          title: 'arrow funcitons',
          description: 'this video is everything that you need to know about lorem ipsume sti dolorum anum.'
        },
        {
          id: 2,
          video_url: 'wfMtDGfHWpA',
          img: 'https://cdn-images-1.medium.com/max/800/1*jAG7WcT_5ORS6BmpI1LJGg.jpeg',
          title: 'video title',
